export default function VictoryOverlay({ show, winner, isDraw, lastHash, onNewGame }) {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={onNewGame}
        className="mt-5 px-8 py-3 bg-ink text-paper font-serif-sc text-sm tracking-[4px] hover:bg-ink-light transition-colors"
      >
        再来一局
      </button>
    </div>
