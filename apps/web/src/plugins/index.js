...
export const GAME_CATALOG = [
  ...
  },
  {
    ...
    aiEngines: [
      {
        ...
        version: '1.0.0',
        difficulties: {
          easy:   { label: 'MCTS 50 sims',   depth: 0 },
          medium: { label: 'MCTS 200 sims',  depth: 0 },
          hard:   { label: 'MCTS 800 sims',  depth: 0 },
          expert: { label: 'MCTS 3000 sims', depth: 0 },
        },
      },
    ],
    ranked: false,
    ...
    eloKey: null,
    aiSide: 2,
    aiDescription: '你执黑先行，AI 执白。中国规则，贴目 6.5。',
    localDescription: '两名玩家在同一设备上轮流落子。黑方先行。',
    aiParams: [],
  },
  {
